...
DEFAULT_PRODUCTS = [
    Product(
        ...
        price=1899.0,
        category="tenis",
        images=["https://picsum.photos/seed/runner/600"],
    ...
    Product(
        ...
        price=2499.0,
        category="tenis",
        images=["https://picsum.photos/seed/trail/600"],
    ...
    Product(
        ...
        price=899.0,
        category="ropa",
        images=["https://picsum.photos/seed/hoodie/600"],
    ...
    Product(
        ...
        price=499.0,
        category="ropa",
        images=["https://picsum.photos/seed/tee/600"],
    ...
    Product(
        ...
        price=349.0,
        category="accesorios",
        images=["https://picsum.photos/seed/cap/600"],
